...
results_folder_lenet5_attacks_trial = os.path.join(".", "results_folder_lenet5_attacks_trial")
cap_results   = os.path.join(".", "Cap parameters results")
...
seed = 100  # Specify Random Seed. Helps to debug issues that appear seldom.
